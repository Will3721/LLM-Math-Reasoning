...
# Prepare prompts
formatted_prompts = [format_prompt(question) for question in questions["normal"]] # normal or irrelevant

# Perform batch processing
outputs = pipe(formatted_prompts, max_new_tokens=512)

# Save the original list structure to JSON
with open("res/qwen_normal.json", "w") as f:
    json.dump(outputs, f)
...
with open("res/qwen_normal_acc.txt", "w") as f:
